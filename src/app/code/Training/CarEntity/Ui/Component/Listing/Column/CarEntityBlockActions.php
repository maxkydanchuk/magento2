...
namespace Training\CarEntity\Ui\Component\Listing\Column;
 ...
 */
class CarEntityBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'CarEntity';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'car_entity/carentity/edit';
    private const DELETE_URL_PATH = 'car_entity/carentity/delete';
    /** #@- */
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item['car_entity_id'])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = ['car_entity_id' => $item['car_entity_id']];
