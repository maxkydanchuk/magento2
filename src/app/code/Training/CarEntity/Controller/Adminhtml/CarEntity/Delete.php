...
use Training\CarEntity\Command\CarEntity\DeleteByIdCommand;

/**
 * Delete CarEntity controller.
 */
class Delete extends Action implements HttpPostActionInterface, HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        $entityId = (int)$this->getRequest()->getParam('car_entity_id');

        try {
            $this->deleteByIdCommand->execute($entityId);
            $this->messageManager->addSuccessMessage(__('You have successfully deleted CarEntity entity'));
